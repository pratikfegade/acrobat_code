...
class TVM_DLL OperationNode : public Object {
 public:
   ...
   */
  virtual void PropBoundToInputs(const Schedule& schedule, const Operation& self,
...
class PlaceholderOpNode : public OperationNode {
 public:
  ...
  void PropBoundToInputs(const Schedule& schedule, const Operation& self, arith::Analyzer* analyzer,
                         const std::unordered_map<const VarNode*, IntSet>& dom_map,
