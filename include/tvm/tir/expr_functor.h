...
class ExprFunctor<R(const PrimExpr& n, Args...)> {
 ...
 public:
  ...
  virtual R VisitExpr_(const ScatterLoadNode* op, Args... args) EXPR_FUNCTOR_DEFAULT;
 ...
 private:
  ...
  static FType InitVTable() {
    ...
    IR_EXPR_FUNCTOR_DISPATCH(ScatterLoadNode);
...
class TVM_DLL ExprVisitor : public ExprFunctor<void(const PrimExpr&)> {
 ...
 protected:
  ...
  void VisitExpr_(const ScatterLoadNode* op) override;
